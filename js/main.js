...
window.onload = function () {
    ...
    datetime = oDt.getFullYear() + "年" + iMonth + "月" + oDt.getDate() + "日 " + sWd + " ";
...
function showtime() {
    ...
    document.getElementById("date-time").innerHTML = datetime + sTime;
}
...
function carousel() {
    ...
    document.getElementById("b-ad").src = sImgSrc;
    document.getElementById(sAchange).style.backgroundColor = "hsl(150, 40%, 30%)";
    document.getElementById(sArestore).style.backgroundColor = "hsl(85, 55%, 50%)";
    iCount = iCount + 1;
...
function changebgcolor(iNum) {
    ...
    for (var iC = 1; iC <= 5; iC++) {
        ...
        if (iC == iNum) {
            document.getElementById(sA).style.backgroundColor = "hsl(150, 40%, 30%)";
        }
        else {
            document.getElementById(sA).style.backgroundColor = "hsl(85, 55%, 50%)";
        }
    }
}
